...
string[] enemyNames = { "Gorlock the Destroyer",  "Bober", "Pingwin", "bob", "József", "Fereng", "Vojtech", "Cailu", "Maru", "Togepi", "Kirby"};
...
void Tutorial()
{
    ...
    if (choice.ToUpper() == "Y")
    {
        ...
        Print("Milo (Your Friend) comes over and offers he'll comes with you if you help him get some mushrooms");
        Print("Will you help him with the Shrooms :3 (Y/N)");
...
void Print(string text, int speed = 1)
{
...
{
    Print("блять, The Motherland is in great danger comrade, we shall defend ourselves.");
    Print("Player Turn");
    ...
    switch (battleChoice)
    {
        ...
        case "4":
            ...
            Print("And you ran away like a capitalist scum");
            break;
